...
describe('test/jsonp.test.js', () => {
  ...
  it('should pass and return callback function name', function* () {
    yield request(app.callback())
      .get('/mark?_callback=fn')
      .expect(200)
      .expect('/**/ typeof fn === \'function\' && fn({"jsonpFunction":"fn"});');
  });

  it('should pass and return callback function name is false', function* () {
    yield request(app.callback())
      .get('/mark')
      .expect(200)
  ...
  it('should pass and return error message', function* () {
    yield request(app.callback())
      ...
      .expect(200)
      .expect('/**/ typeof fn === \'function\' && fn({"msg":"jsonpFunction is readonly"});');
  });
});
